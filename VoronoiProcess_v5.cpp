/*
	Name: Voronoi Processing Program_v5
	Date: 06/09/18 
	Input: XDATCAR;
	Output: voroimport, RESULT, VORONOI_RESULT;
	Description: add the output of Voronoi volume
*/
...
void voronoiGenerate()
{
	...
	FILE *fp1 = fopen("voronoiTessellation/RESULT", "w");
...
int main(int argc, char const *argv[])
{
	...
	if(fopen("voronoiTessellation/VORONOI_RESULT", "r") != NULL)
		remove("voronoiTessellation/VORONOI_RESULT");
